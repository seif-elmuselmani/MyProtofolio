...
export const trustPartners = [
  { 
    ...
    color: "#d97706",
    bgColor: "#fef3c7",
    logo: "/assets/partners/depi-real.jpg",
    linkUrl: "/credentials",
    linkText: "استعراض شهادة التكريم الرئاسي",
    proofUrl: "/assets/certificates/cert-depi-fullstack-dotnet.jpg",
    proofTitle: "الشهادة الرئاسية الرسمية بالمركز الأول على مستوى الجمهورية (DEPI)",
    proofType: "image"
  },
  { 
    id: "mcit",
    ...
    badge: "الجهة الحكومية الراعية",
    category: "وزارة الاتصالات",
    color: "#1e3a8a",
    bgColor: "#eff6ff",
    logo: "/assets/partners/mcit-real.png",
    linkUrl: "/credentials",
    linkText: "استعراض اعتماد وزارة الاتصالات",
    proofUrl: "/assets/certificates/cert-ai-microsoft-mcit.png",
    proofTitle: "اعتماد وتوثيق وزارة الاتصالات وتكنولوجيا المعلومات (MCIT)",
    proofType: "image"
  },
  { 
    id: "microsoft",
    name: "Microsoft Platform", 
    enName: "Microsoft AI Certified", 
    badge: "اعتماد Microsoft",
    category: "شريك تكنولوجي",
    color: "#0284c7",
    bgColor: "#f0f9ff",
    logo: "/assets/partners/microsoft-official.svg",
    linkUrl: "/credentials",
    linkText: "استعراض شهادة مايكروسوفت",
    proofUrl: "/assets/certificates/cert-ai-microsoft-mcit.png",
    proofTitle: "اعتماد مايكروسوفت الرسمي في الذكاء الاصطناعي والتطبيقات البرمجية",
    proofType: "image"
  },
  { 
    id: "nti",
    ...
    badge: "تدريب مكثف 210 ساعة",
    category: "معهد قومي متقدم",
    color: "#059669",
    bgColor: "#ecfdf5",
    logo: "/assets/partners/nti-real.jpg",
    linkUrl: "/credentials",
    linkText: "استعراض شهادة اعتماد NTI",
    proofUrl: "/assets/certificates/cert-nti-210h.jpg",
    proofTitle: "شهادة اعتماد المعهد القومي للاتصالات NTI بواقع 210 ساعة تدريب عملي",
    proofType: "image"
  },
  { 
    id: "iti",
    ...
    color: "#7c3aed",
    bgColor: "#f5f3ff",
    logo: "/assets/partners/iti-real.png",
    linkUrl: "/credentials",
    linkText: "استعراض شهادة معهد ITI",
    proofUrl: "/assets/certificates/cert-deeplearning-iti.png",
    proofTitle: "شهادة اعتماد معهد تكنولوجيا المعلومات ITI في الذكاء الاصطناعي والتعلم العميق",
    proofType: "image"
  },
  { 
    id: "hackerrank",
    name: "HackerRank", 
    enName: "HackerRank Verified", 
    badge: "SQL Verified Skills",
    category: "تقييم عالمي",
    color: "#16a34a",
    bgColor: "#f0fdf4",
    logo: "/assets/partners/hackerrank-official.svg",
    linkUrl: "/credentials",
    linkText: "الانتقال لشهادات HackerRank",
    proofUrl: "/assets/certificates/cert-sql-intermediate-hackerrank.png",
    proofTitle: "شهادات واعتمادات HackerRank العالمية في تقييم المهارات",
    proofType: "image"
  },
  { 
    id: "zagazig",
    ...
    badge: "بكالوريوس جيد جداً",
    category: "مؤهل أكاديمي",
    color: "#2563eb",
    bgColor: "#eff6ff",
    logo: "/assets/partners/zagazig-real.jpg",
    linkUrl: "/credentials",
    linkText: "استعراض بيان النجاح الرسمي",
    proofUrl: "/assets/certificates/cert-zagazig-cs-degree.jpg",
    proofTitle: "بيان نجاح وتخرج رسمي معتمد - بكالوريوس علوم الحاسب مع مرتبة التقدير جيد جداً",
    proofType: "image"
  },
  { 
    id: "ischool",
...
export const certificatesList = [
  {
    ...
    pdfUrl: "",
    description: "بيان نجاح وتخرج رسمي معتمد بتقدير عام جيد جداً، مشروع التخرج بتقدير ممتاز (A+) مع مرتبة الشرف وتولّي قيادة الفريق الهندسي."
  },
  {
    id: "depi-dotnet-scholarship",
    title: "شهادة منحة مبادرة مصر الرقمية (DEPI) - Full Stack .NET",
  ...
  },
  {
    ...
    title: "شهادة مسار اللغة الإنجليزية للأعمال (DEPI & Berlitz)",
    issuer: "Berlitz Egypt & مبادرة مصر الرقمية (DEPI)",
    date: "ديسمبر 2025",
    issueDate: "2025-12",
    category: "english",
    verificationId: "",
  ...
  },
  {
    ...
    title: "شهادة التدريب المكثف في تطوير الويب الكامل .NET (210 ساعة)",
    issuer: "المعهد القومي للاتصالات (NTI)",
    date: "ديسمبر 2025",
    issueDate: "2025-12",
    category: "mcit",
    verificationId: "",
    ...
    pdfUrl: "",
    description: "شهادة تدريب عملي مكثف بواقع 210 ساعة تدريبية معتمدة من المعهد القومي للاتصالات في بناء تطبيقات المؤسسات باستخدام ASP.NET Core & C#."
  },
  {
    ...
    pdfUrl: "",
    description: "شهادة معتمدة في أساسيات الذكاء الاصطناعي وتطبيقاته العملية في دعم مشاريع العمل الحر والإنتاجية التقنية."
  },
  {
    id: "mcit-microsoft-ai",
    title: "شهادة الذكاء الاصطناعي بالتعاون مع مايكروسوفت (Microsoft & MCIT AI)",
    issuer: "Microsoft & وزارة الاتصالات وتكنولوجيا المعلومات",
    date: "2025",
    issueDate: "2025",
    category: "ai",
    verificationId: "",
    ...
    pdfUrl: "",
    description: "شهادة تدريب معتمدة من شركة مايكروسوفت ووزارة الاتصالات في تقنيات ومبادئ الذكاء الاصطناعي الحديث."
  },
  {
    id: "iti-deep-learning",
    title: "شهادة أساسيات التعلم العميق (Deep Learning Essentials)",
  ...
  {
    id: "almdrasa-git",
    title: "شهادة احتراف إدارة النسخ Git & GitHub (منصة المدرسة)",
    issuer: "منصة المدرسة (Almdrasa)",
    date: "2025",
    issueDate: "2025",
    category: "tools",
    verificationId: "",
    ...
    pdfUrl: "",
    description: "شهادة احترافية في إدارة النسخ وسير العمل الجماعي على GitHub وتطوير البرمجيات التعاوني."
  },
  {
    id: "hackerrank-sql-basic",
    title: "شهادة قواعد البيانات SQL Basic - HackerRank",
    issuer: "HackerRank",
    date: "2025",
    issueDate: "2025",
    category: "databases",
  ...
  },
  {
    ...
    title: "شهادة قواعد البيانات SQL Intermediate - HackerRank",
    issuer: "HackerRank",
    date: "2025",
    issueDate: "2025",
    category: "databases",
