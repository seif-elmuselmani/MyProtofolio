...
export default function ProjectCard({ project }) {
  ...
  return (
    <div className="corporate-card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Project Thumbnail */}
      <div style={{ position: 'relative', width: '100%', aspectRatio: '16/9', overflow: 'hidden', backgroundColor: '#f1f5f9' }}>
        <img 
          src={project.image} 
          alt={project.title}
          style={{
        ...
        >
          {project.badge && (
            <span className="pill-badge pill-gold" style={{ boxShadow: '0 2px 8px rgba(217, 119, 6, 0.15)' }}>
              <Sparkles size={12} />
              {project.badge}
            </span>
          )}
